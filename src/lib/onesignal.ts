...
export const OneSignal = {
   ...
   */
  async notifyNewMatch(matchDetails: { equipo_a: string, equipo_b: string, liga: string, canal: string }) {
   ...
   */
  async sendSystemNotification(vendorId: string, title: string, message: string) {
    return this.sendNotification({
